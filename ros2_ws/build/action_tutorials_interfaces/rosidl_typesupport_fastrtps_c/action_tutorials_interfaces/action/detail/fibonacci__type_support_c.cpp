...
{
  return max_serialized_size_action_tutorials_interfaces__action__Fibonacci_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_action_tutorials_interfaces__action__Fibonacci_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_action_tutorials_interfaces__action__Fibonacci_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_action_tutorials_interfaces__action__Fibonacci_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_action_tutorials_interfaces__action__Fibonacci_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_action_tutorials_interfaces__action__Fibonacci_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_action_tutorials_interfaces__action__Fibonacci_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_action_tutorials_interfaces__action__Fibonacci_FeedbackMessage(
    full_bounded, 0);
}
